...
export default function updateChildren(parentElm, oldCh, newCh) {
    ...
    while (oldStartIdx <= oldEndIdx && newStartIdx <= newEndIdx) {
        console.log("❤")
        if (oldStartNode == null || oldCh[oldStartNode] == undefined) {
            oldStartNode = oldCh[++oldStartIdx];
        } else if (oldEndNode == null || oldCh[oldEndNode] == undefined) {
            oldEndNode = oldCh[--oldEndNode];
        } else if (newStartNode == null || newCh[newStartNode] == undefined) {
            newStartNode = newCh[++newStartIdx];
        } else if (newEndNode == null || newCh[newEndNode] == undefined) {
        ...
        if (checkSameVnode(oldStartNode, newStartNode)) {
            ...
            if(idxInOld == undefined) {
                ...
                parentElm.insertBefore(elmToMove.elm, newStartNode.elm);
            }
            newStartNode = newCh[++newStartIdx];
        }
    }
